...
export const UTILITIES = [
  ...
  { id: "balance-confirmation", title: "Balance Confirmation", description: "Generate and track third-party balance confirmation requests.", icon: Handshake, status: "soon", accent: "rose" },
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className={`w-10 h-10 grid place-items-center border ${active ? `${a.bg} ${a.border} ${a.text}` : "border-[#D4D4D0] text-[#52524E]"}`}>
      ...
      <div className={`mt-5 inline-flex items-center gap-1 font-mono text-[11px] uppercase tracking-[0.12em] ${active ? a.text : "text-[#8A8A83]"}`}>
        {active ? (
