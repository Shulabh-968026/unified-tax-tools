...
async def upload(
    ...
    if file_type not in FILE_TYPE_KEYS:
        raise HTTPException(400, f"Unknown file_type '{file_type}'")
    # `output` file-types are generated by modules — never user-uploaded.
    if FILE_TYPE_BY_KEY[file_type].get("kind") == "output":
        raise HTTPException(
            400,
            f"{FILE_TYPE_BY_KEY[file_type]['label']} is auto-generated by a utility; it cannot be uploaded directly.",
        )
